...
| **Successor directions** ([DIRECTIONS.md](DIRECTIONS.md)) | six candidates spawned by RS-amendment-2-3 | D1 baseline-choice critique of PE-removal evaluation · D2 reconstructed ≠ functional position · D3 retrieval depends on RoPE's relative-offset primitive · D4 context collapse after removal · D5 G6 ceiling · D6 RoPE-as-training-warmup. Each costed; most inherit everything they need | **$0 for D1/D2**, cheap GPU for D3/D5, real training only for D6 |
